...
import { formatCurrencyNoUnit } from "../../../Helpers/formatCurrency.js";
import { useTransactionStore } from "../../../Helpers/cartStore.js";
import { cashBookService } from "../../../Helpers/functionsSupabase.js";
              ...
              {/* <div className="grid grid-cols-1 md:grid-cols-4 gap-2 mt-2 mb-2">
                <div className="bg-white p-3 border border-gray-300 flex flex-col shadow-sm">
                  ...
                  <span className="text-green-600 text-lg font-bold">
                    {formatCurrencyNoUnit(totalAmount)}
                  </span>
                </div>
                <div className=" bg-blue-100 p-3 border border-gray-300 flex flex-col shadow-sm">
                ...
                <div className="bg-white p-3 border border-blue-200 flex flex-col shadow-sm">
                  <span className="text-gray-500 text-[10px] uppercase font-bold italic">
                    Dự kiến thu nợ
                  </span>
                  ...
                  <table className="border-collapse w-full min-w-[1200px]">
                    <thead className="bg-[#f0f0f0] sticky top-0 z-10">
                      ...
                      <tr>
                        ...
                        <th className="w-24 border border-gray-300 px-2 py-2 text-center font-bold text-gray-700 uppercase text-[11px]">
                          Loại
                        </th>
                          ...
                          item.transaction_type == "PAYABLE" ? (
                            ...
                            >
                              ...
                              <td className="border-r border-gray-300 px-2 py-1.5 text-center">
                                <span
                                  className={`px-2 py-0.5 rounded-full text-[10px] font-bold uppercase bg-red-100 text-red-700`}
                                >
                                  Dự kiến chi
                                </span>
                              </td>
                              ...
                              <td
                                className={`border-r border-gray-300 px-2 py-1.5 text-right font-bold text-red-600`}
                              >
                                {item.payable_amount
                                  ? formatCurrencyNoUnit(item.payable_amount)
                                  : ""}
                              </td>
                              <td className="border-r border-gray-300 px-2 py-1.5 text-center">
                                {item.payment_method
