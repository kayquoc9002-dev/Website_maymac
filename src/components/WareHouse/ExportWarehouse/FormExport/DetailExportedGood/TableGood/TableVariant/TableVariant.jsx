import { goodService, batchItems } from "../../../../../../../Helpers/functionsSupabase";
...
function TableVariant({
  ...
  useEffect(() => {
    const getData = async () => {
      ...
      try {
        ...
        const result = await batchItems.getAllBatch(selectedGoodId);
        console.log(result);
        setData(result);
      } catch (error) {
  ...
  const handleSubmit = () => {
    const getData = async () => {
      try {
        const result = await batchItems.getBatchItem(
          selectedGoodVariant.current,
        );
        // updateSelectedGood({
        //   ...result,
        //   variants: result.map((item) => {
        //     return { ...item, quantity: 0, note: "" };
        //   }),
        // });
        updateSelectedGood(
          result.map(item => {
      ...
      <div class="bg-white w-[900px] h-[600px] rounded-lg  shadow-lg z-30 flex flex-col">
            ...
            <div class="flex flex-wrap items-center gap-4 text-sm">
              ...
              <div class="flex items-center gap-2">
                ...
                <div class="flex items-center border border-gray-300 rounded overflow-hidden">
                  ...
                  <button
                    type="button"
                    class="px-2 py-1.5 bg-gray-50 border-l border-gray-300 text-gray-500 hover:bg-gray-100"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="14"
              ...
              <div class="flex-grow flex gap-2">
                ...
                <button
                  type="button"
                  class="bg-[#2A3255] hover:bg-[#1e2440] text-white px-4 py-1.5 rounded flex items-center gap-2 font-medium"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="16"
        ...
        <div className="px-2 flex-1 flex flex-col overflow-y-auto">
            ...
            <table class="w-full  border-collapse text-sm ">
              <thead class="bg-gray-100 sticky top-0 z-10 shadow-sm">
                <tr>
                  ...
                  <th class="border border-gray-300 p-2 text-center font-semibold text-gray-700 w-1/4">
                    Mã lô hàng
                  </th>
                  <th class="border border-gray-300 p-2 text-center font-semibold text-gray-700 w-1/6">
                    Mã biến thể
                  </th>
                  <th class="border border-gray-300 p-2 text-center font-semibold text-gray-700 W-1/6">
                    Kích thước
          ...
          <div class="bg-white p-2 border-t border-gray-300 flex items-center gap-1 text-sm sticky bottom-0">
            <button
              type="button"
              class="p-1 border border-gray-300 rounded hover:bg-gray-100 text-gray-500"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="16"
            ...
            <button
              type="button"
              class="p-1 border border-gray-300 rounded hover:bg-gray-100 text-blue-600 ml-1"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="16"
        ...
        <div className="px-2">
          ...
          <div class="bg-white p-4 px-2 border-t border-gray-300 flex justify-end items-center gap-3">
            <button
              type="button"
              class="px-4 py-2 border border-gray-300 rounded text-gray-600 font-medium hover:bg-gray-50 flex items-center gap-2"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="16"
            ...
            <button
              type="button"
              class="px-4 py-2 text-gray-700 font-medium hover:text-gray-900 flex items-center gap-1"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="16"
