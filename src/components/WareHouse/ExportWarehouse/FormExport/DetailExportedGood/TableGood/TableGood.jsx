...
//   const [selectedGood, setSelectedGood] = useState({});
  ...
  useEffect(() => {
    const getData = async () => {
      ...
      try {
        ...
        const result = await batchItems.getGood();
        console.log(result);
        setData(result);
      } catch (error) {
  ...
  const openTableVariant = () => {
    // const good = data.find(item => item.id == selectedGoodId )
    // setSelectedGood({
    //     good_sku: good.good_sku,
    ...
    {selected && (
        <div className="fixed inset-0 z-40 flex justify-center items-center">
          ...
          openTableGood={openTableGood}
            closeTableVariant={closeTableVariant}
      ...
      <div class="bg-white w-[900px] h-[600px] rounded-lg  shadow-lg z-30 flex flex-col">
        ...
        <div class="bg-gray-100 px-4 py-2 flex justify-between items-center border-b border-gray-300">
          ...
          <div class="flex space-x-2 text-gray-400">
            ...
            <button type="button" class="hover:text-gray-600" onClick={openTableGood}>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="16"
                height="16"
