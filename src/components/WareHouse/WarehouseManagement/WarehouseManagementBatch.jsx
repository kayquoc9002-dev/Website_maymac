...
import Row from "./RowBatch/Row";
import { useState, useEffect } from "react";
import Option from "./OptionWarehouse/Option";
function WarehouseManagementBatch() {
  const [data, setData] = useState([]);
  useEffect(() => {
    const getData = async () => {
      // const result = await fetchData(stock);
      const result = await batchItems.getGoodByBatch();
      console.log(result);
      setData(result);
    };
    getData();
        ...
        <div class="flex w-screen">
          ...
          <div class=" flex-1 w-[100px] flex flex-col h-screen bg-gray-50 font-sans text-sm">
            ...
            {/* <header class="flex items-center  bg-white px-4 py-2 border-b border-gray-200 h-8 shrink-0">
              <h1 class="text-sm font-bold text-gray-800 p-2 hover:bg-gray-200">Quản lý theo hàng</h1>
              <h1 class="text-sm font-bold text-gray-800 p-2 hover:bg-gray-200">Quản lý theo lô</h1>
            </header> */}
                ...
                <table class="border-collapse w-full">
                  <thead class="bg-[#f0f0f0] sticky top-0 z-10 ">
                    ...
                    <tr>
                      ...
                      <th class=" border border-gray-300 px-18 py-2 text-center font-bold text-gray-700 whitespace-nowrap">
                        Mã lô hàng
                      </th>
                      <th class="w-70 border border-gray-300 px-12 py-2 text-center font-bold text-gray-700 whitespace-nowrap">
                        Kho
                      </th>
                      ...
                      <th class="w-40 border border-gray-300 px-12 py-2 text-center font-bold text-gray-700 whitespace-nowrap">
                        Ngày
                      </th>
                      <th class="w-40 border border-gray-300 px-12 py-2 text-center font-bold text-gray-700 whitespace-nowrap">
                        Giờ
...
export default WarehouseManagementBatch;
