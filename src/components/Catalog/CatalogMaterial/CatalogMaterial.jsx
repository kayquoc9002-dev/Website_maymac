...
import RowInfoMaterial from "./RowInfoMaterial/RowInfoMaterial";
        ...
        <div class="flex w-screen">
          ...
          <aside class="w-52 flex-shrink-0 bg-[#0f1c3f] text-gray-300 flex flex-col transition-all duration-300">
            ...
            <div class="h-12 flex items-center justify-center bg-[#091026] text-white font-bold text-lg shadow-md">
              <span class="text-white">MISA</span>
              <span class="text-blue-400 italic">eShop</span>
            </div>
            ...
            <nav class="flex-1 overflow-y-auto py-2 custom-scrollbar">
              <ul class="space-y-0.5">
                ...
                <li class="px-4 py-2 bg-[#1e2d55] border-l-4 border-blue-500 cursor-pointer flex items-center gap-3">
                  <svg
                    class="w-5 h-5"
                    fill="none"
                    stroke="currentColor"
                  ...
                  <span class="text-white font-medium">Danh mục</span>
                </li>
                <li class="px-4 py-2 hover:bg-[#1e2d55] cursor-pointer flex items-center gap-3">
                  <svg
                    class="w-5 h-5"
          ...
          <div class=" flex-1 w-[100px] flex flex-col h-screen bg-gray-50 font-sans text-sm">
            ...
            <header class="flex items-center justify-between  bg-white px-4 py-2 border-b border-gray-200 h-14 shrink-0">
              <h1 class="text-xl font-bold text-gray-800">Nguyên liêu </h1>
                ...
                <table class="border-collapse w-full">
                  <thead class="bg-[#f0f0f0] sticky top-0 z-10">
                    ...
                    <tr>
                      ...
                      <th class="w-38 border border-gray-300 px-2 py-2 text-center font-bold text-gray-700 whitespace-nowrap">
                        Mã SKU
                      </th>
                      <th class="min-w-[100px] border border-gray-300 px-2 py-2 text-center font-bold text-gray-700 whitespace-nowrap">
                        Tên nguyên liêu
                      </th>
                      <th class="w-38 border border-gray-300 px-2 py-2 text-center font-bold text-gray-700 whitespace-nowrap">
                        Nhóm nguyên liệu
                      </th>
                      <th class="w-24 border border-gray-300 px-2 py-2 text-center font-bold text-gray-700">
                        Đơn vị tính
                      </th>
                      <th class="w-56 border border-gray-300 px-2 py-2 text-center font-bold text-gray-700 whitespace-nowrap">
                        Nhà cung cấp
                      </th>
                      <th class="w-42 border border-gray-300 px-2 py-2 text-center font-bold text-gray-700 whitespace-nowrap">
                        Giá mua TB
                      </th>
                      <th class="w-42 border border-gray-300 px-2 py-2 text-center font-bold text-gray-700 whitespace-nowrap">
                        Quản lý theo
