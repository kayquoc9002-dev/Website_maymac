      ...
      {selected && (
        ...
        <div
          className={`absolute inset-0 bg-black transition-opacity duration-300   ${
              selected ? "opacity-60 pointer-events-auto" : "opacity-0 pointer-events-none"
            }`}
        >
          // {/* Overlay */}
                ...
                <table class="border-collapse ">
                  <thead class="bg-[#f0f0f0] sticky top-0 z-10">
                    ...
                    <tr>
                      ...
                      <th class="border border-gray-300 px-12 py-2 text-left font-bold text-gray-700 whitespace-nowrap">
                        Mã khách hàng
                      </th>
                      <th class="border border-gray-300 px-12 py-2 text-left font-bold text-gray-700 whitespace-nowrap">
                        Tên khách hàng
                      ...
                      <th class="border border-gray-300 px-3 py-2 text-center font-bold text-gray-700 whitespace-nowrap">
                        Là nhà cung cấp
                      </th>
                      <th class="border border-gray-300 px-12 py-2 text-left font-bold text-gray-700 whitespace-nowrap">
                        Tỉnh thành
...
export default CatalogCustomer;
