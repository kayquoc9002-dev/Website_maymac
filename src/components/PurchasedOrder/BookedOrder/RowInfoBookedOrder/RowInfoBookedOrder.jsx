...
function RowInfoBookedOrder({bookedOrder, selectedId, handleSelect}) {
  return (
    <>
      ...
      <tr class="hover:bg-gray-50">
        ...
        <td class="border border-gray-300 px-2 py-1.5">{bookedOrder.recorded_date} - {bookedOrder.recorded_time}</td>
        ...
        <td class="border border-gray-300 px-2 py-1.5">{formatCurrency(bookedOrder.total_amount)}</td>
        <td class="border border-gray-300 px-2 py-1.5">{bookedOrder.status}</td>
