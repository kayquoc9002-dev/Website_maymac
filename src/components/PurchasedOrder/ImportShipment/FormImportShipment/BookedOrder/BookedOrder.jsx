...
function BookedOrder({ openFormGood }) {
  // const [data, setData] = useState([]);
  const [selectedOrderId, setSelectedOrderId] = useState("");
  const { option, store, removeStore, addOption, removeOption } = useStore();
  // useEffect(() => {
  //   const getData = async () => {
        ...
        <div class="p-4 space-y-3 border-b border-gray-300">
          <div class="flex flex-wrap items-center gap-4 text-sm">
            ...
            <div class="flex items-center gap-2">
              <label class="whitespace-nowrap font-medium">Nhóm hàng hóa</label>
              <div class="relative">
