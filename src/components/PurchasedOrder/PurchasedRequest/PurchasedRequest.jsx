...
import RowPurchasedRequest from "./RowPurchasedRequest.jsx";
import { useState } from "react";
import FormPurchasedRequest from "./FormPurchasedRequest/FormPurchasedRequest.jsx";
import Header from "../../PartsOfPage/Header.jsx";

function PurchasedRequest() {
    ...
    <>
      {selected && (
        <div className="fixed inset-0 z-20 flex justify-center items-center">
          ...
          <FormPurchasedRequest openForm={openForm} dataOrder={data} edittedData={edittedData} setData={setData}/>
              ...
              <div class="flex-1 overflow-x-auto relative ">
                <table class="border-collapse w-full">
                  ...
                  <tbody class="bg-white text-gray-800">
                    {/* <!-- Row 1 (Selected) --> */}
                    {data.map((item) => (
                      <RowPurchasedRequest bookedOrder={item} selectedId={selectedId} handleSelect={handleSelect}/>
                    ))}
                    {/* <!-- Row 2 --> */}
                    {/* {data.map((item) => (
...
export default PurchasedRequest;
