...
import { receivedOrderService } from "../../../../Helpers/functionsSupabase.js";
import RowGoodReceipt from "./RowGoodReceipt.jsx";
...
const [data, setData] = useState();
  useEffect(() => {
    const getData = async () => {
      ...
      try {
        const result = await receivedOrderService.getAllReceipt();
        console.log(result);
        setData(result);
      } catch (error) {
