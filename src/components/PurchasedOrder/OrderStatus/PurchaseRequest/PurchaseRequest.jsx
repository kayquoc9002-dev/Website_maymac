...
import RowRequest from "./RowRequest.jsx"
import { useState, useEffect } from "react";
import Navigator from "../Navigator.jsx";
import { requestService } from "../../../../Helpers/functionsSupabase.js";
function PurchaseRequest() {
  ...
  //             // {/* Overlay */}
  //           </div>
  //           <FormInfoOrderStatus openForm={openForm} />
        ...
        <div class="flex w-screen">
          ...
          <div class=" flex-1 w-[100px] flex flex-col h-screen bg-gray-50 font-sans text-sm">
            ...
            <header class="flex items-center justify-between  bg-white px-4 py-2 border-b border-gray-200 h-14 shrink-0">
              <h1 class="text-xl font-bold text-gray-800">Theo dõi hàng</h1>
            ...
            <div class="p-2 flex-1 flex flex-col overflow-hidden bg-gray-300">
              {/* <!-- Tabs --> */}
              <Navigator type="purchaserequest" />
              {/* <!-- Toolbar --> */}
                ...
                <table class="border-collapse w-full">
                  <thead class="bg-[#f0f0f0] sticky top-0 z-10 ">
                    ...
                    <tr>
                      ...
                      <th class="w-70 border border-gray-300 px-6 py-2 text-center font-bold text-gray-700 whitespace-nowrap">
                        Số phiếu
                      </th>
                      <th class="w-50 border border-gray-300 px-12 py-2 text-center font-bold text-gray-700 whitespace-nowrap">
                        Người lập
                      </th>
                      <th class="w-60 border border-gray-300 px-12 py-2 text-center font-bold text-gray-700 whitespace-nowrap">
                        Kho yêu cầu
                      </th>
                      {/* <th class="w-50 border border-gray-300 px-12 py-2 text-center font-bold text-gray-700 whitespace-nowrap">
                        Tổng tiền
                  ...
                  <tbody class="bg-white text-gray-800">
                    {/* <!-- Row 1 (Selected) --> */}
                    {data ? data.map((item) => <RowRequest request={item}/>) : <></>}
                    {/* <!-- Row 2 --> */}
                    {/* {data.map((item) => (
